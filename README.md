...
1. 接 PostgreSQL 或 MySQL
2. 引入 Flyway 做第一版 schema migration
3. 将内存版 `MediaTaskService` 替换为持久化实现
4. 增加 repository / service / controller 更明确分层
5. 为接口补齐 integration test 与错误响应约束
